...
export default class MDVWiFiControllerAccessory extends BaseAccessory {
    device;
    configDev;
    service;
    ...
    percentageToFanSpeed(percentage) {
        ...
        if (percentage <= 14)
            return FanSpeed.Sleep;
        if (percentage <= 28)
            return FanSpeed.Micron;
        if (percentage <= 43)
            return FanSpeed.Low;
        if (percentage <= 57)
            return FanSpeed.Mid;
        if (percentage <= 71)
            return FanSpeed.High;
        if (percentage <= 86)
            return FanSpeed.SuperHigh;
        return FanSpeed.Power;
    }
}
//# sourceMappingURL=MDVWiFiControllerAccessory.js.map