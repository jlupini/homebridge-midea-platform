...
export default class DehumidifierAccessory extends BaseAccessory {
    ...
    pumpService;
    waterTankContactService;
    waterTankLeakService;
        ...
        for (const [k, v] of Object.entries(attributes)) {
            ...
            switch (k.toLowerCase()) {
                ...
                case 'pump':
                    ...
                    break;
                case 'tank_full':
                    this.waterTankLeakService?.updateCharacteristic(this.platform.Characteristic.LeakDetected, v);
                    this.waterTankContactService?.updateCharacteristic(this.platform.Characteristic.ContactSensorState, v);
                    break;
