...
export var HeatStatus;
(function (HeatStatus) {
    HeatStatus[HeatStatus["Auto"] = 0] = "Auto";
    HeatStatus[HeatStatus["On"] = 16] = "On";
    HeatStatus[HeatStatus["Off"] = 32] = "Off";
...
(function (Mode) {
    ...
    Mode[Mode["Cool"] = 8] = "Cool";
    Mode[Mode["Auto"] = 16] = "Auto";
})(Mode || (Mode = {}));
export var FanSpeed;
(function (FanSpeed) {
    FanSpeed[FanSpeed["Auto"] = 128] = "Auto";
    FanSpeed[FanSpeed["Power"] = 64] = "Power";
    FanSpeed[FanSpeed["SuperHigh"] = 32] = "SuperHigh";
    FanSpeed[FanSpeed["High"] = 16] = "High";
    FanSpeed[FanSpeed["Mid"] = 8] = "Mid";
    FanSpeed[FanSpeed["Low"] = 4] = "Low";
    FanSpeed[FanSpeed["Micron"] = 2] = "Micron";
    FanSpeed[FanSpeed["Sleep"] = 1] = "Sleep";
})(FanSpeed || (FanSpeed = {}));
class MessageCCBase extends MessageRequest {
 ...
 */
function parseTLVBody(body, isControlResponse) {
...
export class CCTLVMessageBody extends MessageBody {
    ...
    error_code;
    temp_fahrenheit;
    constructor(body, isControlResponse) {
        super(body);
...
//# sourceMappingURL=MideaCCMessage.js.map