...
export declare const AUTO_FAN_SPEED = 102;
...
export default class MideaACDevice extends MideaDevice {
    ...
    readonly FAN_RELATED_MODES: string[];
    ...
    private disable_all_fan_related_modes;
    set_fan_auto(fan_auto: boolean): Promise<void>;
    set_fan_speed(fan_speed: number, message: MessageGeneralSet | MessageSubProtocolSet): void;
    set_fan_related_mode(mode: string, state: boolean, message: MessageGeneralSet | MessageSubProtocolSet): void;
