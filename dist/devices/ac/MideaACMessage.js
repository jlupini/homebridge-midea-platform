...
class XA0C0BaseMessageBody extends MessageBody {
    power; // powerValue
    mode; // modeValue
    fan_speed; // fanspeedValue
    swing_vertical; // swingUDValue
    swing_horizontal; // swingLRValue
    boost_mode; // strongWindValue
    power_saving; // power_saving
    comfort_sleep_mode; // Computed from comfortableSleepValue & comfortableSleepSwitch
    comfort_sleep_value; // comfortableSleepValue
    comfort_sleep_switch; // comfortableSleepSwitch
    pmv; // pmv
    dry; // dryValue
    aux_heating; // PTCValue
    purifier; // purifierValue
    eco_mode; // ecoValue
    sleep_mode; // sleep_status
    natural_wind; // naturalWind
    prevent_cold; // preventCold
    full_dust; // dust_full_time
    swing_lr_switch; // swingLRUnderSwitch
    swing_lr_value; // swingLRValueUnder
    frost_protect; // arom
    constructor(body) {
        super(body);
...
class XA0MessageBody extends XA0C0BaseMessageBody {
    target_temperature; // temperature & smallTemperature
    smart_dry; // smartDryValue
    temp_fahrenheit; // temperature_unit
    screen_display; // screenDisplayNowValue
    comfort_mode; // comfortPowerSave
    constructor(body) {
        super(body);
...
class XC0MessageBody extends XA0C0BaseMessageBody {
    ...
    screen_display; // screenDisplayNowValue
    comfort_mode; // comfortPowerSave
    indoor_temperature; // indoorTemperatureValue & smallIndoorTemperatureValue
    outdoor_temperature; // outdoorTemperatureValue & smallOutdoorTemperatureValue
    constructor(body) {
        super(body);
